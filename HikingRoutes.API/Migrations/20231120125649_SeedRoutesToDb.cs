...
{
    /// <inheritdoc />
    public partial class SeedRoutesToDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("4d768d8a-7a9f-4061-b5fc-964f41c025be"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("5e0d9eda-160c-4f5a-a4c3-f589d5f8762a"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("cbf3bc94-4b25-45ba-87a9-d90b126c36ed"));

            migrationBuilder.DeleteData(
                table: "Regions",
                keyColumn: "Id",
                keyValue: new Guid("0d5351cf-08a7-44c8-ac19-c5b9d51a4043"));

            migrationBuilder.DeleteData(
                table: "Regions",
                keyColumn: "Id",
                keyValue: new Guid("1904eec3-54e2-4414-8f8b-11fd6db89d78"));

            migrationBuilder.DeleteData(
                table: "Regions",
                keyColumn: "Id",
                keyValue: new Guid("2d1ebc01-e498-49d0-9930-febde9e3eccb"));

            migrationBuilder.DeleteData(
                table: "Regions",
                keyColumn: "Id",
                keyValue: new Guid("52c4f5f6-bc37-42c2-82d0-963c613b6304"));

            migrationBuilder.DeleteData(
                table: "Regions",
                keyColumn: "Id",
                keyValue: new Guid("534c8e19-4139-44ef-8821-42e612c5ddf9"));

            migrationBuilder.DeleteData(
                table: "Regions",
                keyColumn: "Id",
                keyValue: new Guid("715942c4-dd73-40da-ad1d-9c3569526c56"));

            migrationBuilder.DeleteData(
                table: "Regions",
                keyColumn: "Id",
                keyValue: new Guid("aeaa1778-e134-41a5-a1a2-e5cc1ec5b095"));

            migrationBuilder.DeleteData(
                table: "Regions",
                keyColumn: "Id",
                keyValue: new Guid("b2edc066-9784-4f4e-9dc6-e2e4a8838889"));

            migrationBuilder.DeleteData(
                table: "Regions",
                keyColumn: "Id",
                keyValue: new Guid("fcf590f9-508d-4728-a79d-3e8698ce9b08"));

            migrationBuilder.DeleteData(
                table: "Routes",
                keyColumn: "Id",
                keyValue: new Guid("12272e37-4887-4281-b7ed-a3777084863b"));

            migrationBuilder.DeleteData(
                table: "Routes",
                keyColumn: "Id",
                keyValue: new Guid("8a804a54-d291-4201-adde-0c62873061c7"));

            migrationBuilder.DeleteData(
                table: "Routes",
                keyColumn: "Id",
                keyValue: new Guid("b1eda23c-351c-4eb9-9ed0-6de5ced0d8ce"));

            migrationBuilder.DeleteData(
                table: "Routes",
                keyColumn: "Id",
                keyValue: new Guid("cf053382-889a-407a-8d73-ad85e4f0d11a"));

            migrationBuilder.DeleteData(
                table: "Routes",
                keyColumn: "Id",
                keyValue: new Guid("e09a40c8-3c9c-4e79-a485-cfb54864b8a3"));
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("4d768d8a-7a9f-4061-b5fc-964f41c025be"), "Easy" },
                    { new Guid("5e0d9eda-160c-4f5a-a4c3-f589d5f8762a"), "Medium" },
                    { new Guid("cbf3bc94-4b25-45ba-87a9-d90b126c36ed"), "Hard" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0d5351cf-08a7-44c8-ac19-c5b9d51a4043"), "SOF", "Sofia", "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Sofia_%28province%29_in_Bulgaria.svg/1024px-Sofia_%28province%29_in_Bulgaria.svg.png" },
                    { new Guid("1904eec3-54e2-4414-8f8b-11fd6db89d78"), "YAM", "Yambol", "https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Yambol_in_Bulgaria.svg/1024px-Yambol_in_Bulgaria.svg.png" },
                    { new Guid("2d1ebc01-e498-49d0-9930-febde9e3eccb"), "VAR", "Varna", "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cb/Varna_in_Bulgaria.svg/1024px-Varna_in_Bulgaria.svg.png" },
                    { new Guid("52c4f5f6-bc37-42c2-82d0-963c613b6304"), "SIL", "Silistra", "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Silistra_in_Bulgaria.svg/1024px-Silistra_in_Bulgaria.svg.png" },
                    { new Guid("534c8e19-4139-44ef-8821-42e612c5ddf9"), "SLI", "Sliven", "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Sliven_in_Bulgaria.svg/1024px-Sliven_in_Bulgaria.svg.png" },
                    { new Guid("715942c4-dd73-40da-ad1d-9c3569526c56"), "VID", "Vidin", "https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Yambol_in_Bulgaria.svg/1024px-Yambol_in_Bulgaria.svg.png" },
                    { new Guid("aeaa1778-e134-41a5-a1a2-e5cc1ec5b095"), "PLO", "Plovdiv", "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Plovdiv_in_Bulgaria.svg/250px-Plovdiv_in_Bulgaria.svg.png" },
                    { new Guid("b2edc066-9784-4f4e-9dc6-e2e4a8838889"), "BUR", "Burgas", "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Burgas_in_Bulgaria.svg/1024px-Burgas_in_Bulgaria.svg.png" },
                    { new Guid("fcf590f9-508d-4728-a79d-3e8698ce9b08"), "PLE", "Pleven", "https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/Pleven_in_Bulgaria.svg/1024px-Pleven_in_Bulgaria.svg.png" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("12272e37-4887-4281-b7ed-a3777084863b"), "Друг маршрут, който ви предлагаме, се намира в Стара планина и се намира само на 56 км от Пловдив.  Разходката е подходяща както за един ден, така и за два. Посоката, която трябва да хванете, е Калофер, а крайната точка е екопътека „Бяла река”.\r\n\r\nРайонът се отличава с красива природа и най-вече със страхотна кухня. Отправяме се на път към екопътека „Бяла река”. Ще стигнете и до бивак Бялата река, от който започва и красивата екопътека. Разкриват се уникални гледки от реката и малки водопади. Тук могат да бъдат видени 11 уникални за района растителни вида. В Национален парк Централен балкан също така има и огромно разнообразие от животински видове, сред които: мечки, вълци, диви кози, царски орли и редица други.\r\n\r\nПреходът е лесен и продължава около час. В района има няколко беседки и обособени места за пикник, на които също може да починете.", new Guid("777c4644-a5f7-42a5-a086-44ecd5ece1ce"), 8.0, "Бяла река", new Guid("da1d1365-ee7e-43f5-95f4-90b4eebaf65c"), "https://trafficnews.bg/data/images/2021_04_28/DSC_0085-800x500.jpg" },
                    { new Guid("8a804a54-d291-4201-adde-0c62873061c7"), "копътеката започва над стария квартал \"Варуша\" и се изкачва по североизточните склонове на \"Картала\", като колкото по-високо се качва, толкова гледката към старата част на града става по-панорамна и красива. Оттук пътеката се спуска през местност наречена \"Зелени дол\", за да достигне до красив водопад. След водопада се продължава в подножието на западния скален венец на прохода Дервент, през който река Янтра напуска Търново и се отправя в северна посока към Дунавската равнина, за да се достигне до манастира. Това е добра възможност за разходка сред природата, комбинирана с посещение на Преображенския манастир, чрез която да се разтоварите и заредите с положителни емоции.", new Guid("cfdb74d0-8ef8-43ba-81a5-cc6d5fe36270"), 3.0, "Екопътека до Преображенския манастир", new Guid("f9f73085-0059-4837-85e2-6995d0656b82"), "https://www.bestplacesinbulgaria.com/wp-content/uploads/2017/01/preobrajenski-monastery-stara-planina-mountain-tourist-eco-route-04.jpg" },
                    { new Guid("b1eda23c-351c-4eb9-9ed0-6de5ced0d8ce"), "Този туристически маршрут води началото си от село Сирищник и води до изкачване на най-високия връх на планина Рудини – връх Сирищнишка рудина. Името на екопътека „Поглед към девет планини“, както можете да се досетите, идва от зашеметяващата гледка във всички посоки от вишката, изградена на върха. Указателна табела ще ви насочи накъде какво виждате, но лично според мен се виждат повече от 9 планини. По пътя нагоре ще минете по горска пътека, покрай един малък параклис, по виещо дървено стълбище, ще поставите и своя камък в интересната мозайка „Окото“, след което ще изкачите и връх Сирищнишка рудина. ", new Guid("cfdb74d0-8ef8-43ba-81a5-cc6d5fe36270"), 6.0, "Екопътека „Поглед към девет планини“ ", new Guid("6ed072ff-7d65-4288-851b-0d7669060ce9"), "https://tripsjournal.com/wp-content/uploads/2016/03/po-stylbite-nadolu-300x169.jpg" },
                    { new Guid("cf053382-889a-407a-8d73-ad85e4f0d11a"), "Маршрутът е с историческа и биологична насоченост и с продължителност около 2 ч. 30 м.\r\nНачалото на Хайдушката пътека е до Информационно-Посетителския център на парка. По маркирана пътека след около 2 часа се достига до Туристически комплекс Карандила. Поема се на север по асфалтов път и след 30 минути се достига извора Кушбунар, разположен във вековна букова гора, която е обявена за природна забележителност.", new Guid("777c4644-a5f7-42a5-a086-44ecd5ece1ce"), 6.0, "Хайдушка пътека гр.Сливен ", new Guid("81ad011c-60f0-4969-90db-219e3e2a5728"), "https://tripsjournal.com/wp-content/uploads/2016/03/kym-ravninata.jpg" },
                    { new Guid("e09a40c8-3c9c-4e79-a485-cfb54864b8a3"), "До екопътеката може да стигнете лесно от Плевен в посока Ловеч, преминавайки през селата Брестовец и Тодорово и Горталово. Освен, че ще се озовете в пълен унисон с природата, в мястото са изградени много барбекюта, беседки и места за отдих.", new Guid("b26b0570-cf97-49a6-a74e-acf6ed6c58d0"), 7.0, "Екопътека Чернелка", new Guid("c94159c3-715c-4ed1-8649-6a28130d5563"), "https://www.360mag.bg/wp-content/uploads/2020/06/%D0%B5%D0%BA%D0%BE%D0%BF%D1%8A%D1%82%D0%B5%D0%BA%D0%B0-%D1%87%D0%B5%D1%80%D0%BD%D0%B5%D0%BB%D0%BA%D0%B0.jpg" }
                });
        }
    }
}
